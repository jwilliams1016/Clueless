...
public class clueLessModel {
	...
	static Location hallway1;
	static Location hallway2;
	static Location hallway3;
	static Location hallway4;
	static Location hallway5;
	static Location hallway6;
	static Location hallway7;
	static Location hallway8;
	static Location hallway9;
	static Location hallway10;
	static Location hallway11;
	static Location hallway12;
	private Player[] playerList;
	private Location[] locationList;
	private int numActivePlayers;
	static int numPlayers = 0;
	static int numDisabled = 0;
	static boolean disproven = false;
	static int f = 0;
